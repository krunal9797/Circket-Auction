...
export const LiveAuctionBoard: React.FC = () => {
  ...
  return (
    <div className="space-y-6 pb-16 max-w-[1400px] mx-auto">
      ...
      {/* Top Broadcast Sponsor Ticker Bar */}
      <SponsorSlideshow variant="ticker" autoPlayInterval={4000} className="shadow-lg" />
      ...
      {/* TOURNAMENT SPONSORS BROADCAST STAGE */}
      <div className="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-2xl space-y-4">
        <div className="flex items-center justify-between border-b border-slate-800 pb-3">
          <div className="flex items-center gap-2">
            <Sparkles className="w-5 h-5 text-amber-400" />
            <h3 className="font-sports text-2xl font-bold text-white tracking-wide uppercase">
              OFFICIAL TOURNAMENT SPONSOR SPOTLIGHT
            </h3>
          </div>
          <span className="text-xs text-slate-400 font-medium">
            Live Stadium Rotating Showcase
          </span>
        </div>

        <SponsorSlideshow variant="broadcast" autoPlayInterval={5000} />
      </div>
